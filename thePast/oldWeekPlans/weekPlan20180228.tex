...
\item \tiny Work: reply to Bronis . 
\item \tiny worklife: update information on Work/rel with ref. letter
  information.

\item \tiny Work:rel:cvl:upd: do cover letter for LLNL = Work: rel:
  explain reason for wanting to join LLNL + Work:rel:(cvl): explain
  your contributions.  \te{1 hour}  \dl{}. 

\item \tiny Work:rel: send out LLNL application \te{1 hour}
  \dl{Wednesday}. 

\item \tiny Work: update research experience on webpage. 
\item \tiny Mgmt:wp: add pics on Instagram.
\item \tiny Mgmt:wp: update wallpaper on FB. 
...
\item \tiny Work: admin: finish re-imbursements for Denver =
  Work:admin: get ticket for flight to DC.
