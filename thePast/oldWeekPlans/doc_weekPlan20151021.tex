  ...
  \begin{columns}
    ...
    \begin{column}{0.50\linewidth}
      ...
      \begin{block}{Running TODO} % find a better name 
        ...
        \doneTask{ Work:comm: send Prof. Gropp slides for presentation
          next week \te{10 minutes}}
        ...
        \doneTask{ Work: slides(rev): finish XPACC slides =
          Work:slides(rev): write the XPACC slides results + Work:
          slides (rev): }
...
% later 
        ...
        \item \tiny Work: rel: send Resume to Sandia \te{20 minutes} 
