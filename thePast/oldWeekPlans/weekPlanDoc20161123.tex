...
\begin{block}{} 
{\underline{\textbf{Week of December $1^{st}$, 2016:}}}
\begin{itemize} 
\tiny \item \tiny Work: 
\item \tiny Work:
\item \tiny Work:
\item \tiny Work:
\end{itemize}
{\underline{\textbf{Week of December $7^{th}$, 2016:}}}
\begin{itemize} 
\tiny \item \tiny
\item \tiny 
\item \tiny 
...
\item \tiny Comm:
\end{itemize} 
{\underline{\textbf{Week of Dec $19^{th}$, 2016:}}}
\begin{itemize} 
...
\end{itemize}
{\underline{\textbf{Week of October $24^{th}$ 2016:}}}
\begin{itemize}
\tiny \item \tiny Work: 
\item \tiny Comm: 
\item \tiny Comm: 
...
\begin{column}{0.5\linewidth} 
  \begin{block}{Week Summary} 
    {\tiny \underline{\textbf{Week Plan} EI: PHP, Work: do prep for
        SC, Mgmt:Spaces: book flight, Mgmt:webpresence: post on FB,  } \tiny }
  ...
  \begin{block}{Running ToDo} % find a better name 
    ...
    \item \tiny Mgmt:Spaces: check for automatic renewal - WSJ, Sirius
      XM, linkedIn, Google Express , Hello Fresh. 
    \item \tiny Work: rel: decision 

USC : 

Brookhaven : 

bnl  - defined :   organization :  scientist  - salary  : 

project :  4-6 years - salary :  
...
\tiny \item \tiny Work: talk to Abid  

\item \tiny  Work:rel: talk to Torsten 

\item \tiny Work:rel: reply to JP 



 Dear Dr. Chandrasekaran,
 
I'm a PhD graduate of Professor Bill Gropp. My dissertation involved
OpenMP loop scheduling strategies for scientific applications. 
...
on your faculty webpage while searching the web for other
information. 


I'd like to read the paper. I can't obtain a copy of the paper from
the web. Can you send a copy of the paper to me if possible?
...
Vivek
  ...
  \begin{block}{Week Daily Schedule} 
    ...
    \newline {\bf Mon:} 
    \newline {\bf Tues:}
    \newline {\bf Wed:} Work: message to Abid, Work: prep to talk to
    Maria, Work: email to ISI 
    \newline {\bf Thur:} EI: message for PHP, Work: message to Sunita
    + Work: slides, Mgmt:Spaces: new phone, Mgmt:Spaces: 
    \newline {\bf Fri:} 
    \newline {\bf Sat:}  
  \end{block} 
