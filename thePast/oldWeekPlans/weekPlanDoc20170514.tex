  ...
  \begin{column}{0.6\linewidth}
    ...
    \end{block}
      \begin{block}{Running ToDo} % find a better name 
        \begin{enumerate} 
          \doneTask{Mgmt:Spaces: get reimbursements done.}
          \doneTask{Comm: message to Chris.} \te{10 minutes} 
          \doneTask{ Work: add OpenMPCon2017 paper}
          \doneTask{Comm: message to Chris about meeting. }
          \doneTask{ Comm: message to Ranjit about this weekend} \te{10 minutes}. 
        ...
        \item \tiny Work(opc:w): add outline to paper. \te{1 hour}. 

        \item \tiny Mgmt:wp: post about Queen. 
        \item \tiny Mgmt:wp: post about Neil deGrasse Tyson. 
        \item \tiny Mgmt:wp: post about Beckham. 

        \item \tiny Comm: read social intelligence. \te{2  hour}. 

        \item \tiny Comm: message on Bharatmatrimony \te{10 minutes}.           
        \item \tiny Comm: respond to Shaadi.com \te{15 minutes}. 
        \item \tiny Comm: message to Coffee meets Bagel. \te{10 minutes}. 
        \item \tiny Comm: message on Dilmil. \te{10 minutes}.
        \item \tiny Comm: message to Renata \te{10 minutes}.
        \item \tiny Comm: message to Padma Aunty \te{1 hour}.

        \item \tiny Comm: catch up with Matrimony posts. \te{2 hours}. 

        \item \tiny Comm: update pictures. \te{30 minutes} 
