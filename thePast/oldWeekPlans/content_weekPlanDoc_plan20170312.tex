    ...
    \end{block}
      ...
      \begin{block}{Running ToDo} % find a better name 
        \begin{enumerate}          
          ...
          \doneTask{ Work:admin: ask for vacation.} \te{10 minutes}
          \dl{TuesNight} \pr{high}
          \doneTask{Work: message to Prof. Gropp about plan.} \te{30
            minutes} \dl{tonight} \pr{high}. 

        \doneTask{Work: admin: finish survey.}
        \item \tiny Work:comm: figure out whether to add Anshu \te{1
          hr}. 
        ...
        \item \tiny Work:rel: message to Kristina about Roy's
          email. \te{10 minutes} \dl{ImportantForLongTermConnections} 
        ...
        \item \tiny Mgmt:Spaces: empty trash of photos from Photo booth \te{10
          minutes}
        ...
        \item \tiny Work:admin(spaceSave): Goto MacStore and See if the following can be uninstalled and then
          ...
          \doneTaskNoItem{Mgmt:Spaces: figure out how to uninstall macports} 
