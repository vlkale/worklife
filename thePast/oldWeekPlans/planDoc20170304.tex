...
\tiny \tiny Weekend of January $15^{th}$: I'll be in the D.C. Area. Atul is visiting. Things from moving company will be
moved. Details: 
...
{\underline{\bf Weekend Plans -February 3, 2017 to March 15, 2017}} 
\begin{itemize}
...
\item \tiny Weekend of March $10^{th}$: Visit New York. Details: 
\end{itemize} 

{\underline{\bf Weekend Plans - March $15^{th}$, 2017 to May $1^{st}$, 2017}}
\begin{itemize}
\item \tiny Weekend of March $17^{th}$: 
\item \tiny Weekend of March $24^{th}$: 
\item \tiny Weekend of March $31^{st}$: 
\item \tiny Weekend of April $6^{th}$: 
\item \tiny Weekend of April $13^{th}$: 
\item \tiny Weekend of April $20^{th}$: 
\item \tiny Weekend of April $26^{th}$: 
\end{itemize}

{\underline{\bf  Weekend plans for weekends between May $1^{st}$, 2017 and June$1^{st}$, 2017}}
\begin{itemize}
\item \tiny Weekend of May $5^{th}$:
