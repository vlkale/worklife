  ...
  \begin{column}{0.6\linewidth}
    ...
    \end{block}
      \begin{block}{Running ToDo} % find a better name 
        ...
        \item \tiny Work: message to Karthik about poster. \te{10
          minutes}. 
          \doneTask{ Work(psm): do calculations.} 
        \doneTask{ Work: admin: send Claire credit card. }
      \item \tiny Work(psm): talk about calculations. 
      \doneTask{Comm: text to Rohina.} \te{10 minutes} \pr{Urgent}. 
      \doneTask{ Comm: rel: message to Sonia B. about meeting.}
      \doneTask{ Comm: rel: message to Rohini about meeting. }
      
      \doneTask{Comm: message to Puja }\te{20 minutes} 
      \doneTask{ Comm: reply to Shikha.} \te{10 minutes} \pr{UI} \dl{} 
        \doneTask{Comm: talk to Atul.} \te{10 minutes}. 
      \doneTask{ Comm: message to Namrata. }\te{10 minutes}
        \dl{Tuesday} \pr{Urgent}.
      \doneTask{ Comm: message to Namrata.} \te{10 minutes}
        \dl{Friday} \pr{ImportantSinceSheIsFamily} 
      \doneTask{ Mgmt:Spaces: call about dentist appointment. } 

      \doneTask{Mgmt:wp: add fb pictures with Puja} 
      \doneTask{ Mgmt:wp: update fb with pictures.} \pr{UI}
        \dl{Saturday} \pr{UrgentToKeepFriendsGoing}. 
    \doneTask{Mgmt:wp: add picture from Shwaytha's wedding of
        people in front of River.} 
      \doneTask{Mgmt:wp: put up facebook pictures from BMM with
        Shalaka. }
     \doneTask{ Comm: message to Sweta.} \te{10 minutes} \dl{Friday}
        \pr{ImportantSinceSheIsNice} 
      \doneTask{Work(psm): add document to Overleaf. }

      \doneTask{Mgmt:wp: Hbd to Shuchi. }
      ...
      \item \tiny Work(psm): do writeup for summary. \te{20 minutes} 
      \item \tiny Work(psm): do document with slides \te{10 minutes}. 

      \item \tiny Work: send Dad the reviews for OpenMPCon. \te{3
        minutes}. \dl{Thursday} \pr{UI}. 
        
      \item \tiny Mgmt:Spaces: get flight for labor day
        weekend. \te{30 minutes} \pr{IU} \dl{Thursday} =
        \doneTaskNoItem{Mgmt:Spaces: find return flight} +
        Mgmt:Spaces: find flight going.  

      \item \tiny Mgmt:Spaces: find flight for weekend after Labor
        day. \te{10 minutes}  \pr{IU} \dl{Friday}
      ...
      \item \tiny Mgmt:wp: add picture of Smithsonian on
        Instagram. \te{1 hour} 
      ...
      \item \tiny Mgmt:wp: happy bd to Sneha Borikar. 
       ...
       \item \tiny Work: message to 
        
      \item \tiny Comm: send Shwayta a message. \te{20 minutes}} 

      \item \tiny Comm: talk to Vinita. \te{30 minutes} \dl{Friday} \pr{UI} 
      \item \tiny Comm: message to Rishi and Mike about meeting.
      \item \tiny Comm: message to Nitin Mama about meeting.         
      ...
      \item \tiny Mgmt:wp: update fb with pictures. \te{20 minutes}
        \dl{Friday} \pr{IU}. 
        
      \item \tiny Mgmt:wp: add tags of photos from this past weekend. 
      \item \tiny Mgmt:wp: add photos from college. 
      \item \tiny Comm: talk to Atul. \te{20 minutes} \pr{UI}. 

              
      \item \tiny Comm: message to girl. \te{10 minutes} \pr{Urgent}. 
      \item \tiny Comm: talk to Shalaka. \te{10 minutes} \pr{Urgent}.   
      \item \tiny Comm: message to Sweta. \te{10 minutes}. 
      ...
      \item \tiny Comm: message to Rishi and Mike about meeting.
        ...
        \item \tiny Work: get results for n-body. \te{1 hour} 
