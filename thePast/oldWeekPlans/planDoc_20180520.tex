...
%\fi
\begin{enumerate}
\doneTask{ Work: reply to Prof. Chapman. }
...
\item \tiny Mgmt:Spaces:(bst): update basement =
  \doneTaskNoItem{Mgmt:Spaces(bst): fix bed} + Mgmt:Spaces(bst): put up posters + Mgmt:Spaces(bst): set up tv
  + Mgmt:Spaces(bst): set up computer  + \doneTaskNoItem{Mgmt(bst):
    put up futon} 
...
\tiny\csvautotabular{/Users/vivekkale/Desktop/ViveksLaptop2/life/thePast/situations/jobsList.csv} 

%    \pgfplotstabletypeset[col sep=comma, % the seperator in our .csv
                                % file
%      header=true,

%      columns={Job,JobDesc,Category,coverLetter,applied,
%        interview,result, salary, benefits},
%      columns/Job/.style={column type=l,string type},
%      columns/JobDesc/.style={column type=l,string type},
%      columns/Category/.style={column type=l,string type},
%      columns/coverLetter/.style={column type=l,string type},
%      columns/applied/.style={column type=l,string type},
%      columns/phoneScreen/.style={column type=l,string type},
%      columns/interview/.style={column type=l,string type},
%      columns/result/.style={column type=l,string type},
%      columns/salary/.style={fixed,fixed zerofill,precision=1,column type=r},
%      columns/benefits/.style={column type=l,string type},

%      every head row/.style={before row=\toprule, after row=\midrule},
%      every last row/.style={after row=\bottomrule}
%  ]{jobsList.csv} % filename/path to file 
