  ...
  \begin{columns}
    ...
    \begin{column}{0.50\linewidth}
      ...
      \begin{block}{Running TODO} % find a better name 
        ...
        \item \tiny Work(SCPrep): prep for SC = \doneTaskNoItem{Work(SCprep): answer emails from Prof. Gropp about booth} + Work(SCprep):   +
          Work(SCprep): get presentation done  +
          Work(SCPrep): get slides done + \doneTaskNoItem{Work(SCPrep): talk to
            Prof. Gropp to meet + Work(SCPrep): talk to Luke to meet}  +
         \doneTaskNoItem{Work(SCprep): talk to Amanda} 
       ...
       \item \tiny \doneTaskNoItem{Work(SCJobs): reply to nvidia} + Work(SCJobs): talk to BNL + Work(SCJobs): 
    ...
    \begin{column}{0.20\linewidth}
      ...
      \begin{block}{Situations}
        ...
        \begin{itemize} 
          ...
          \tiny \item \tiny \textit{Situation:Meet Atul} Pre-:  
          Post-: watch the lights switching off / push your chair in. 

          \tiny \item \tiny \textit{Situation: meet with Saroj} Pre-: 
          Be prepared: have cash. make reservation. Comb hair. Brush
          teeth.  Topics: / bhangra , house of cards ty
...
We need to meet to discuss career paths.  Do you have time on Wednesday afternoon at 2:30 PM? 
