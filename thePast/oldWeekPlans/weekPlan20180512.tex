...
%      \item \tiny Anger about a b  $\rightarrow$ ...
  ...
  \begin{column}{0.6\linewidth}
    ...
    \begin{block}{Running ToDo} % find a better name 
      \doneTask{ Work: send updates to Harshitha}
      \doneTask{Work: send e-mail to Sam Williams} 
      \doneTask{ 
        Hi Sam,
      ...
      \doneTask{Work:rel: create resume of length 1 page.}
      \doneTask{ Mgmt:wp: upload pictures from Los Angeles.  }
      \doneTask{ Mgmt:Spaces: update MetroMile} 
