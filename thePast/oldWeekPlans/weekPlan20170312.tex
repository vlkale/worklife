  ...
  \begin{column}{0.6\linewidth}
    \begin{block}{Week Summary}
      {\underline {\bf Week Plan:} 
        ...
        Work: do ATPESC, Work: update proposal, Work: rel: send e-mail to Liao, Work: job talk updates, 
        worklife: update goals, Work: add content to proposal, Work: add examples to uds, Mgmt:wp: add
        to research statement, Mgmt:Spaces: get flights taken care of
        Comm: contact Toni, 

        Comm: message to Rathi, 
      }\\

{\underline{\bf Weekend Plan:} Go to Champaign} \\  

    \end{block}
    \begin{block}{Running ToDo} % find a better name 
      \begin{enumerate}

        \doneTask{Work:rel: talk with Chunhua Liao.} 
        \doneTask{ Work: send information on publication to Steve and JP.} 
        \te{20 minutes}.
        \doneTask{ Work:rel: talk with Prof. Cappello about application.} 
        \doneTask{Mgmt:wp: add pictures on FB = Mgmt:wp: add picture with Dhanashree + Mgmt:wp: add picture with Mugdha. }
  
      \item \tiny \textbf{Curr} $\rightarrow$  
      \item \tiny worklife: update information on Work/rel with ref. letter information.
      \item \tiny Work:rel:cvl:upd: do cover letter for LLNL = Work: rel: explain reason for wanting to join LLNL + 
        Work:rel:(cvl): explain your contributions.  \te{1 hour}  \dl{}. 

      \item \tiny Work:rel: send out LLNL application \te{1 hour} \dl{Wednesday}. 

      \item \tiny Mgmt:wp: birthday = Mgmt:wp: hbd to Ben Laff + Mgmt:wp: hbd to Mugdha. 

      \item \tiny Work:rel: apply to other LLNL positions. 

      \item \tiny Work: apply for ATPESC. 

      \item \tiny Work: write motivation letter for ATPESC 2018.  
      \item \tiny Work:rel: talk with Martin about meeting.  
      ...
      \item \tiny Work: give information to Mary Ann Leung for summary. 20
        minutes. 
...
I’d like to say one more thing to you.

If you and I were to be in a relationship, I’d work to gain and maintain your trust. I’d do that by talking to you about what I’m feeling in terms of things I’m involved in, such as my job, overcoming my discomfort. I’d do that by telling you if I feel something between us is off rather than keeping it to myself or reacting negatively to it. Additionally, I'd do that by listening deeply to make sure that I understand you. In any case, I want to do these things for my own sake.

I too felt that we could be a good match this past November when we started talking. I understand our situation and that you’ve said that we shouldn’t be pursuing a relationship together now. If you'd like to talk again though, just know that I'd do everything that I can to explore building a lasting relationship together.
...
Pro: she's interested later.  

Con: she sends a negative message to not contact her again. 
...
TODO:L4: like VS want 

want 

      \item \tiny Mgmt:wp: add WhatsApp photo to be that of SF. 
...
Work: send ref letter draft to Steve Crago. 
Work: get help about jobs talking with Prof. Gropp. 
Work: send draft ref. letter for Prof. Gropp. 
Work: send draft for Prof. Cappello. 
Work: send information to Julia Eberhardt. 
Mgmt:Spaces: get dls and title. 

Mgmt:wp: add pictures on website. 

Comm: 

  | Tuesday:  

Comm: prep for event in Fulton. 
  | Wednesday: 
