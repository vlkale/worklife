...
\begin{column}{0.5\linewidth}
  \begin{block}{Week Summary}
    {\tiny \underline{\bf Week Plan} Work: talk to Brian, Work: do
      review, Work: send
      message to Prof. Gropp, Mgmt:wp: Ramya + Mgmt:wp: Joshua,
      Mgmt:wp:  , Comm: accept from Shaadi, Comm: reply from this
      weekend }

    {\tiny \underline{\bf Weekend Plan:} Get stuff from home.} 
  ...
  \item \tiny Work:rel: message to Kristina about Roy's emal
    address. 
  \item \tiny Mgmt:Spaces: get baggage from Southwest + Mgmt:Spaces:
  haircut + Mgmt:Spaces: consider new wheels + Mgmt:Spaces: put cover
  on bed. 
\item \tiny Mgmt:Spaces(call about car): car update  =  Mgmt:Spaces:
    update software +  Mgmt:Spaces: get suit 
\item \tiny Mgmt:webpresence: fb unlike Kavita’s pictures + 
  Mgmt:webpresence: fb like to Joshua + Mgmt:webpresence: fb like to Tanuja + Mgmt:webpresence: fb like to Alyssa. 
...
\item \tiny Work: send message about Whiteboard marker holder to Barbara\te{1 hour}.     
