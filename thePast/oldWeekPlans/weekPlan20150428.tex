...
\textbf{Weekend Plan:} Interview prep, Comm: invitation letter, Work:resume, 
  ...
  \begin{block}{Running TODO} % find a better name 
    \begin{enumerate} 
      % \doneTask{ Work: find a way to finish}
      % \tiny \item \tiny Work: write out mat vec in assignment. 
      % \item \tiny review other codes such as LU factorization. 
      % \item \tiny Work: do coding problems with mat vec in mind. 
      % \item \tiny Work: do mat vec. 
      % \item \tiny do subset sequences. 
      % \item \tiny do program to write out the 
