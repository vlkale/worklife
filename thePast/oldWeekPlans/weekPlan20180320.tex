  ...
  \begin{column}{0.6\linewidth}
    \begin{block}{Week Summary}
      {\underline {\bf Week Plan:} 
        Work: send e-mail to Todd, Work:rel: update LLNL job, Work: send e-mail
        to Prof. Gropp, Work: update proposal, Work: update job talk, 

        %Work: job talk updates, worklife: update goals,
        %Work: add content to proposal, Work: add examples to uds,
        %Mgmt:Spaces: get flights taken care of, Comm: contact Toni, 

      }\\

      {\underline{\bf Weekend Plan:} Go to Boston } \\
    ...
    \begin{block}{Running ToDo} % find a better name 
      ...
      \item \tiny Work:rel:cvl:upd: do cover letter for LLNL = Work:
        rel: explain reason for wanting to join LLNL + Work:rel:(cvl):
        explain your contributions.  \te{1 hour}  \dl{} .

      \item \tiny Work: rel: send Todd an e-mail.  

      \item \tiny Work: send e-mail for accomplishments.
      \item \tiny Work:rel: apply to other LLNL positions. \te{1 hour} \dl{} 
      ...
      \item \tiny Mgmt:Spaces: stamps 
      \item \tiny Mgmt:Spaces: get book from post office. 
