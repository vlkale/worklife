...
<<<<<<< HEAD
       ...
       \doneTask{Work: send information about PtychoLib to Kaushik and
         Andy.}
       \doneTask{Work: send message to Youssef.}
       \doneTask{Mgmt:Spaces: book flight to India.}
       \doneTask{Mmgt:wp: add Mathew Colgrove on linkedIn
         Pro: good contact – stronger contact with BNL.  
        b.Con: bad to BNL – who cares bad to NVIDIA – who cares   -
        bad to NVIDIA trans sunyb – new person.
       } 

       \doneTask{Work:comm: talk to JP about meeting.}
       \doneTask{Mgmt:Spaces: call for AA card.} 
