  ...
  \begin{column}{0.6\linewidth}
    ...
    \end{block}
      ...
      \begin{block}{Running ToDo} % find a better name 
        \begin{enumerate} 
        \doneTask{Mgmt:Spaces: pay Atul back} 
        \doneTask{ Work: comm: reply to Brian Cunliffe}
        \doneTask{ Work: message to Steve about JIT compilers.} \te{1
          hour} \dl{} \pr{}.
        \doneTask{Work: send out email for HiPC.}
        \doneTask{Comm:  set up time to meet with Rohina.} 
        \doneTask{Comm: reply to Anita.} 
        \doneTask{ Work: send email to Prof. Gropp.} 
      \doneTask{ Mgmt:Spaces: pay bill for dominion. }
      \doneTask{Work: admin: set up email.}

    \item \tiny \textbf{Curr} $\rightarrow$ 
    \item \tiny Work: get results with AMR code. \te{2 hours}. 
    \item \tiny Work: do progress report \te{1 hour}. 
    ...
    \item \tiny Work(ltr): get information for Stephen about work =
      ...
      \item \tiny Work: make revisions to paper \te{2 hours}.

      \item \tiny Work: send message to Youssef about question about
        the \texttt{nvprof} \te{1 hour}. 
      \item \tiny Work: do outline for OpenMPCon \te{20 minutes}. 
      \item \tiny Mgmt:Spaces: look for apartment elsewhere. \te{1
        hour}.
      ...
      \item \tiny Mgmt:Spaces: get appointment for medicines or
        request a refill. \te{10 minutes} 
      \item \tiny Mgmt:Spaces: book flight for bmm in July \te{1 hour}.

      \item \tiny Mgmt:Spaces: book flight for trip in December.
        \te{1 hour}. 

      \item \tiny Mgmt:Health: get meds. \te{20 minutes} 

      \item \tiny Mgmt:Spaces: call National for car. \te{10
        minutes}. 

      \item \tiny Mgmt:wp: add Information Sciences Institute to
        Headline for LinkedIn.  \te{5 minutes} 
      \item \tiny Mgmt:wp: change zip code on LinkedIn. \te{5 minutes} 
      \item \tiny Mgmt:wp: fb like for Ridhima's new job. \te{2
        minutes} 
      ...
      \item \tiny Comm: message to Renata. \te{1 hour}. 
