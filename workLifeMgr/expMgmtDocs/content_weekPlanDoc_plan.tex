  ...
  \begin{column}{0.6\linewidth}
    \begin{block}{Week Summary} 
      {\underline {\bf Week Plan:} 
        ...
        Youssef, Work: do outline for OpenMPCon, Mgmt:Spaces: look for
        apartment elsewhere, Work:rel: email to Renata} \\
...
\item \tiny Work(opc:): discuss abstract with Prof. Gropp. \te{20
  minutes} 
 ...
 \item \tiny Work(iwp:pap): change formatting for
   paper. \doneTask{Work(opc:addcitations): add citations.}  

\item \tiny 

Hey Shalaka, Good to hear. 

Yeah, the weather is delightful.

It's going well. I'm in Urbana-Champaign, which is where my parents
live, this weekend. 


 and will be in Chicago on Monday for work.

How are you doing? 

\item \tiny Comm: message to Shwetha. 

A PhD in computer science from UIUC
