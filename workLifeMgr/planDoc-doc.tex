...
\begin{document}
\input{content_projects_plan-doc}
\newpage
\input{content_monthPlanDoc_plan}
\newpage
\pagecolor{yellow!40!orange}
\input{content_weekPlanDoc_plan-doc}
\newpage
\pagecolor{red}
\input{content_socialInt_plan-doc}
\end{document}
